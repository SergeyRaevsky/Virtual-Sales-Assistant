...
<img src="<?php echo esc_url($button_style['icon_url']); ?>" alt="<?php esc_attr_e('Chat Icon', 'virtual-sales-assistant'); ?>" style="width: 24px; height: 24px; fill: <?php echo esc_attr($button_style['icon_color']); ?>;">
<?php else: ?>
...
<img src="<?php echo esc_url($business_logo); ?>" alt="<?php esc_attr_e('Business Logo', 'virtual-sales-assistant'); ?>" style="height: 40px; margin-right: 10px;">
<?php endif; ?>
...
<img src="<?php echo esc_url($avatar_url); ?>" alt="<?php esc_attr_e('Bot Avatar', 'virtual-sales-assistant'); ?>" class="avatar">
<div class="content">
...
<input type="text" id="user-input" placeholder="<?php esc_attr_e('Type a message...', 'virtual-sales-assistant'); ?>" />
<button id="send-button"><?php _e('Send', 'virtual-sales-assistant'); ?></button>
</div>
</div>
</div>
<?php
