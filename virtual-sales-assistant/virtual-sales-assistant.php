<?php
/*
* Plugin Name: Virtual Sales Assistant
Description: A sales manager chatbot plugin using ChatGPT.
 * Version: 4.12
* Author: Sergey Raevsky
*/
...
$business_info = get_option('chatgpt_sales_manager_business_info', __('We specialize in creating high-quality websites and online stores. Our working hours are Monday to Friday from 9:00 AM to 6:00 PM, and Saturday from 10:00 AM to 4:00 PM. Sunday is a day off.', 'virtual-sales-assistant'));
$manager_name = get_option('chatgpt_sales_manager_virtual_manager_name', __('Manager', 'virtual-sales-assistant'));
$greeting = get_option('chatgpt_sales_manager_virtual_manager_greeting', __('Hello! How can I help you today? Please tell me your name.', 'virtual-sales-assistant'));
...
wp_localize_script('chatgpt_sales_manager_js', 'virtual_sales_assistant', array(
...
'you_label' => __('You', 'virtual-sales-assistant'),
'send_button_text' => __('Send', 'virtual-sales-assistant'),
'error_message' => __('Error: ', 'virtual-sales-assistant'),
'generic_error_message' => __('An error occurred while processing your request.', 'virtual-sales-assistant'),
'bot_avatar_alt' => __('Bot Avatar', 'virtual-sales-assistant'),
'default_user_name' => __('User', 'virtual-sales-assistant')
));
}
